...
Pod::Spec.new do |spec|
    ...
    spec.source            = { :http => 'https://github.com/MealzStaging/MealzCoreRelease/raw/release/1.0.3/mealzcore.zip' }
    spec.ios.vendored_frameworks = 'mealzcore.xcframework'
    spec.resource_bundles = {'MealzCore_Privacy' => ['Ressouces/*.xcprivacy']}
end
